...
class Stok extends CI_Controller {
    ...
    function getDataTable()
    {
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = '<a href="'.base_url('stok/history/'.$field['item_id']).'">'.$field['name'].'</a>';
            $row[] = $field['stockInside'];
            $row[] = $field['note'];
            $row[] = '<div class="btn-group">
                            <a href="'.base_url('stok/add/increase/'.$field['item_id']).'" class="btn btn-success">Masuk</a>
                            <a href="'.base_url('stok/add/decrease/'.$field['item_id']).'" class="btn btn-danger">Keluar</a>
                          </div>';
