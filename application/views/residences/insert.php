          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="m-0">Form Tambah Apartemen</h5>
              </div>
              <form class="form-horizontal" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                      <input type="text" name="tower" class="form-control" id="tower" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                      <input type="text" name="blok" class="form-control" id="blok" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <input type="text" name="electricity" class="form-control" id="electricity" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <input type="date" name="date_used" class="form-control" id="date_used" value="<?php echo date('Y-m-d') ?>" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
