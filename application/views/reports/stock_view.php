                ...
                <?php if (isset($stocks)): ?>
                  <div class="table-responsive">
                    <table class="table table-bordered" id="data-table">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if ($value['type'] == 'sale' || $value['type'] == 'sale') {
                                $code = getDataColumn('sales', 'id', $value['transaction_id'], 'code');
                              }
                              elseif ($value['type'] == 'purchase') {
                                $code = getDataColumn('purchases', 'id', $value['transaction_id'], 'code');
                              }
                      ...
                      <tfoot>
                        <tr>
                          <td colspan="3"><strong>Jumlah Stok Tersedia</strong></td>
                          <td colspan="3"><strong><?php echo $sumStock ?></strong></td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
