                ...
                <?php if (isset($purchases)): ?>
                  <div class="table-responsive">
                    <table class="table table-bordered" id="data-table">
                      ...
                      <tbody>
                        <?php $sumPurchase = 0; foreach ($purchases as $key => $value): ?>
                          <tr>
                        ...
                        <?php $sumPurchase += $value['total']; endforeach ?>
                      </tbody>
                      <tfoot>
                        <tr>
                          <td colspan="6"><strong>Total Kas Keluar</strong></td>
                          <td><strong>Rp. <?php echo number_format($sumPurchase) ?></strong></td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
