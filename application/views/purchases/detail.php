          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="d-flex flex-col">
                ...
                <p>
                  <button type="button" id="copy-mode" class="btn btn-primary ml-1">
                    <i class="fa fa-clone"></i>
                    Mode Salin
                  </button>
                </p>
                <p>
                  <button type="button" id="normal-mode" class="btn btn-danger ml-1" style="display:none;">
                    <i class="fa fa-clone"></i>
                    Mode Normal
                  </button>
                </p>
                    ...
                    <tbody>
                      <?php foreach ($details as $key => $value) : ?>
                        <tr>
                          ...
                          <td class="price">Rp. <?php echo number_format($value['price']); ?></td>
                          <td><?php echo $value['qty']; ?></td>
                          <td class="price">Rp. <?php echo number_format($value['price'] * $value['qty']); ?></td>
                        </tr>
                      <?php endforeach ?>
                    </tbody>
                  <?php endif ?>
