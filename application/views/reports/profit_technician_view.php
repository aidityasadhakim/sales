          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <?php if (isset($sales)): ?>
                  <hr>
                  <h4>Setor Teknisi Periode <?php echo date('d F Y', strtotime($start_date)) ?> - <?php echo date('d F Y', strtotime($end_date)) ?></h4>
                    ...
                    <table class="table table-bordered" id="data-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo base_url('service/detail/'.$value['id'].'/teknisi') ?>" target="_blank"><?php echo $value['customer_name']; ?></a></td>
                          <td>Rp. <?php echo number_format($value['total']); ?></td>
                          <td>Rp. <?php echo number_format(getTotalBuyPriceTeknisi($value['id'])); ?></td>
                          <td>
                            <?php $total_profit = $value['total'] - getTotalBuyPriceTeknisi($value['id']); if ($total_profit < 0): ?>
                        ...
                        $total_modal += getTotalBuyPriceTeknisi($value['id']);
                        endforeach 
                        ?>
                      </tbody>
                      <tfoot>
