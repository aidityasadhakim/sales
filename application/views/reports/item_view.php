                  ...
                  <tbody>
                    ...
                    foreach ($items as $key => $value) : ?>
                      <tr>
                        ...
                        <td><?php echo getStockAvailable($value['id']) ?></td>
                        <td>Rp. <?php echo number_format($value['buyPrice']) ?></td>
                        <td>Rp. <?php echo number_format(getStockAvailable($value['id']) * $value['buyPrice']) ?></td>
                      </tr>
                    <?php $totalItem += getStockAvailable($value['id']);
                      $totalPrice += (getStockAvailable($value['id']) * $value['buyPrice']);
                    endforeach ?>
                  </tbody>
                  <tfoot>
                    <tr>
