                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="tower" class="form-control" id="tower" value="<?php echo $unit['tower'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="floor" class="col-sm-3 col-form-label">Lantai</label>
                        <div class="col-sm-2">
                          <input type="text" name="floor" class="form-control" id="floor" value="<?php echo $unit['floor'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                    ...
                    <div class="col">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="el_total_price" class="form-control el_total_price" id="el_total_price" value="<?php echo $row['el_total_price'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="el_last_used" class="form-control" id="el_last_used" value="<?php echo $row['el_last_used'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="el_used" class="col-sm-3 col-form-label">Pemakaian Bulan Ini</label>
                        <div class="col-sm-6">
                          <input type="text" name="el_used" class="form-control" id="el_used" value="<?php echo $row['el_used'] ?>" onblur="validateElPrice()" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="el_total_used" class="col-sm-3 col-form-label">Total Pemakaian</label>
                        <div class="col-sm-6">
                          <input type="text" name="el_total_used" class="form-control" id="el_total_used" value="<?php echo $row['el_total_used'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="el_rate" class="col-sm-3 col-form-label">Tarif Per KWH</label>
                        <div class="col-sm-6">
                          <input type="text" name="el_rate" class="form-control" id="el_rate" value="<?php echo $row['el_rate'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="pasum" class="col-sm-3 col-form-label">Pasum</label>
                        <div class="col-sm-6">
                          <input type="text" name="pasum" class="form-control" id="pasum" value="<?php echo $row['pasum'] ?>" onblur="validateElPrice()" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="ppju" class="col-sm-3 col-form-label">PPJU</label>
                        <div class="col-sm-6">
                          <input type="text" name="ppju" class="form-control" id="ppju" value="<?php echo $row['ppju'] ?>" onblur="validateElPrice()" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="ppn" class="col-sm-3 col-form-label">PPN</label>
                        <div class="col-sm-6">
                          <input type="text" name="ppn" class="form-control" id="ppn" value="<?php echo $row['ppn'] ?>" onblur="validateElPrice()" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="el_subtotal_price" class="col-sm-3 col-form-label">Total Tagihan Listrik</label>
                        <div class="col-sm-6">
                          <input type="text" name="el_subtotal_price" class="form-control el_total_price" id="el_subtotal_price" value="<?php echo $row['el_total_price'] ?>" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="col">
